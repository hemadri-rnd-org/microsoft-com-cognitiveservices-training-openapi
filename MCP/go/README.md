# Custom Vision Training Client MCP Server

This MCP (Model Content Protocol) server provides access to Custom Vision Training Client API functionality through HTTP, HTTPS, and STDIO transport modes.
